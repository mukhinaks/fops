...
func (f *OPFPConstraints) Init(locs []generic.Point) generic.Constraints {
...
func (f *OPFPConstraints) routeTime(route map[int]generic.Point, orderOfLocations []int) int {
	duration := 0
...
func (f *OPFPConstraints) FinalRouteTime(route map[int]generic.Point, orderOfLocations []int) int {
	duration := 0
...
func (f *OPFPConstraints) Boundary(route map[int]generic.Point, orderOfLocations []int) bool {
...
func (f *OPFPConstraints) ReducePoints(route map[int]generic.Point, orderOfLocations []int, locations map[int]generic.Point) map[int]generic.Point {
...
func (f *OPFPConstraints) SinglePointConstraints(location generic.Point, id int) bool {
...
func (f *OPFPConstraints) UpdateConstraint(route map[int]generic.Point, orderOfPoints []int, locations []generic.Point) generic.Constraints {
